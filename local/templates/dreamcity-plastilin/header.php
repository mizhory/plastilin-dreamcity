                    ...
                    <div class="menuPane" id="burger-pane">
                        <div class="menuPane__inner">
                            <div class="menuPane__logo"><a class="menuLogo" href="#"><span class="menuLogo__desktop"><img
                                                src="/local/local/img/41441bb52226d181cdee3f4fb2ddf21c.svg" alt="Лого"></span><span
                                            class="menuLogo__moibile"><img src="/local/local/img/4b4f6571f166bb19037e6d41350876ff.svg"
                                                                           alt="Лого"></span></a></div>
                        ...
                        <svg class="arrBtn__svgr" width="50px" height="50px">
                          <use xlink:href="/local/local/img/svg/icons.svg#menuBurger"></use>
                        </svg><span class="arrBtn__abs">
                          <svg width="32px" height="17px">
                            <use xlink:href="/local/local/img/svg/icons.svg#arrowBurger"></use>
                          </svg></span><span class="arrBtn__cls">
                          <svg width="16px" height="16px">
                            <use xlink:href="/local/local/img/svg/icons.svg#cls"></use>
                        ...
                        <div class="boxContact">
                            <button class="aroundIco" data-modal-open="m-4">
                                <div class="aroundIco__abs">
                                    <svg>
                                        <use xlink:href="/local/local/img/svg/icons.svg#ligntC"></use>
                                    </svg>
                                </div>
                                <div class="aroundIco__inner">
                                    <div class="aroundIco__center">
                                        <svg width="19px" height="18px">
                                            <use xlink:href="/local/local/img/svg/icons.svg#search"></use>
                                        </svg>
                                    </div>
                                </div>
                            </button>
                                ...
                                <div class="aroundIco__inner">
                                    <div class="aroundIco__center">
                                        <svg width="18px" height="18px">
                                            <use xlink:href="/local/local/img/svg/icons.svg#phone"></use>
                                        </svg>
                                    </div>
                                </div>
                            </button>
